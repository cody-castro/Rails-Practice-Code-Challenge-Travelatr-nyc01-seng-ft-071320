...
class BloggersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogger" do
    assert_difference('Blogger.count') do
      post bloggers_url, params: { blogger: { age: @blogger.age, bio: @blogger.bio, name: @blogger.name } }
    end
  ...
  test "should update blogger" do
    patch blogger_url(@blogger), params: { blogger: { age: @blogger.age, bio: @blogger.bio, name: @blogger.name } }
